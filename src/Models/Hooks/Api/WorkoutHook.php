...
namespace Retrocube\ProgramWorkout\Models\Hooks\Api;
...
class WorkoutHook
{
   ...
   */
    public function hook_query_index(&$query,$request, $slug=NULL) {
        //Your code here
        $base_url = \URL::to('/images');
        $query->selectRaw("CONCAT('$base_url',image_url) AS image_url");
    }
    ...
    */
    ...
    public function create_cache_signature($request)
    {
        ...
        return 'WorkoutHook' . md5(implode('',$cache_params));
    }
}
